<%@ Control Language="C#" CodeBehind="MyTemplate.ascx.cs" ClassName="MyTemplate" Inherits="ProjectTaskXAF.Web.MyTemplate" %>
...
<%@ Register Assembly="DevExpress.ExpressApp.Web.v21.1, Version=21.1.6.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.ExpressApp.Web.Templates.ActionContainers"
    TagPrefix="xaf" %>
<%@ Register Assembly="DevExpress.ExpressApp.Web.v21.1, Version=21.1.6.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.ExpressApp.Web.Templates"
    TagPrefix="xaf" %>
<%@ Register Assembly="DevExpress.ExpressApp.Web.v21.1, Version=21.1.6.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.ExpressApp.Web.Controls"
    TagPrefix="xaf" %>
<%@ Register Assembly="DevExpress.ExpressApp.Web.v21.1, Version=21.1.6.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.ExpressApp.Web.Templates.Controls"
    TagPrefix="xaf" %>
            ...
            <tbody>
                <tr class="">
                    <td class="xafNavToggleConteiner ">
                        <div id="toggleNavigation" class="xafNavToggles" tabindex="0" role="button">
...
<div id="mainDiv" class="xafAlignCenter paddings overflowHidden AdditionalClass">
    <asp:Panel runat="server" id="navigation" CssClass="xafNav xafNavHidden" class="bg-success" >
    ...
    <div id="content" class="overflowHidden" >
        <div id="menuAreaDiv" style="z-index: 2500;" class="bg-secondary">
